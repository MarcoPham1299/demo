(function (factory) {
    ...
    var defaultOpts = {
        ...
        locale: "en",
        cancelText: "cancel",
        selectOtherColorText: 'Select other color',
        chooseText: "choose",
            ...
            "<div class='sp-container sp-hidden'>",
                "<div class='sp-palette-container'>",
                    ...
                    "<div class='sp-palette-button-container sp-cf'>",
                        '<a class="text-underline sp-select-other-color"></a>',
                        "<button type='button' class='sp-cancel btn btn-block btn-sm mt-2'></button>",
                    "</div>",
                "</div>",
                "<div class='sp-picker-container'>",
                    "<div class='sp-top sp-cf'>",
                        ...
                        "<div class='sp-top-inner'>",
                            ...
                            "</div>",
                        "</div>",
                        '<div class="sp-transparent">',
                            "<div class='sp-alpha'><div class='sp-alpha-inner'><div class='sp-alpha-handle'></div></div></div>",
                            "<div class='float-right w-22 position-relative'>",
                                "<input class='sp-transparent-persent form-control form-control-sm text-center' step='0.1' type='text' /><span class='sp-percent-append'>%</span>",
                            "</div>",
                        '</div>',
                    "</div>",
                    '<div class="w-100">',
                        "<div class='sp-initial sp-thumb w-32'></div>",
                        "<div class='sp-input-container float-right w-68'>",
                            "<input class='sp-input form-control form-control-sm text-left p-1' type='text' spellcheck='false'  />",
                        "</div>",
                    '</div>',
                    "<div class='sp-button-container w-100 sp-cf'>",
                        "<button type='button' class='sp-cancel btn btn-block btn-sm'></button>",
                    "</div>",
                "</div>",
            "</div>"
        ].join("");
    ...
    function spectrum(element, o) {
        ...
        var doc = element.ownerDocument,
            ...
            alphaInput = container.find(".sp-transparent-persent"),
            paletteContainer = container.find(".sp-palette"),
            initialColorContainer = container.find(".sp-initial"),
            cancelButton = container.find(".sp-cancel"),
            selectOtherColorButton = container.find('.sp-select-other-color'),
        ...
        function applyOptions() {
            ...
            container.toggleClass("sp-palette-disabled", !opts.showPaletteOnly);
        ...
        function initialize() {
            ...
            alphaInput.off().on('input', function () {
                try {
                    clearTimeout(timeoutID);
                } catch (error) {}
                timeoutID = setTimeout(function () {
                    setFromAlphaInput($.trim($(alphaInput).val()));
                }, 400);
            });
            ...
            selectOtherColorButton.text(opts.selectOtherColorText);
            selectOtherColorButton.on("click.spectrum", function (e) {
                e.stopPropagation();
                e.preventDefault();
                opts.showPaletteOnly = false;
        ...
        function setFromAlphaInput (value) {
            if (value == '' || value == null) {
                currentAlpha = 0;
            } else {
                if (isNaN(value)) {
                    ...
                    let _val = parseFloat(value) / 100;
                    if (_val > 1) {
                        _val = 1;
                    }
                    currentAlpha = Math.round(_val * 1000) / 1000;
                }
            }
        ...
        function hide() {
            ...
            // set showPaletteOnly to first palette
            opts.showPaletteOnly = true;
            applyOptions();
        }
        ...
        function updateUI() {
            ...
            if (opts.showInput) {
                ...
                let percent = currentAlpha * 100;
                alphaInput.val(Math.round(percent * 10) / 10);
            }
